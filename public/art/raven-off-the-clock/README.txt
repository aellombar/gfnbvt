SCENE: raven-off-the-clock
GIRL: raven

Two ways to drop art (game accepts both):

PREFERRED — numbered gen packs (prompts already split per layer):
  layer 0: public/gen/12_raven-off-the-clock__0/DROP/image.png
  layer 1: public/gen/13_raven-off-the-clock__1/DROP/image.png
  layer 2: public/gen/14_raven-off-the-clock__2/DROP/image.png
  layer 3: public/gen/15_raven-off-the-clock__3/DROP/image.png
