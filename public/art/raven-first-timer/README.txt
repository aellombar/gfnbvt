SCENE: raven-first-timer
GIRL: raven

Two ways to drop art (game accepts both):

PREFERRED — numbered gen packs (prompts already split per layer):
  layer 0: public/gen/01_raven-first-timer__0/DROP/image.png
  layer 1: public/gen/02_raven-first-timer__1/DROP/image.png
  layer 2: public/gen/03_raven-first-timer__2/DROP/image.png
